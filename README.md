...
Live project: [buildwithkulshresth.com/app](https://buildwithkulshresth.com/app) — **Lumen**, a multi-tenant marketing OS with 4-stage async pipeline, Redis time-wheel handling 1M+ concurrent tasks, provider-agnostic LLM layer, and row-level security PostgreSQL on Kubernetes.
...
- **4-stage async pipeline** via RabbitMQ (generation to review to scheduling to delivery)
...
### Monolith to Microservices Migration at Equinix / Rampwin
